...
{
    // Constantes
    define('TARGET', '../FileUpload/');    // Repertoire cible
    define('MAX_SIZE', 10000000000000);                         // Taille max en octets du fichier
    define('WIDTH_MAX', 200000000000);                           // Largeur max de l'image en pixels
    define('HEIGHT_MAX', 200000000000);                          // Hauteur max de l'image en pixels

// Tableaux de donnees
    $tabExt = array('xlsm','pdf','docx','dotx');          // Extensions autorisees
    $infosImg = array();
...
if($templateChoose==1)
{
    ...
    $insertArticle =$objConnect->InsertArticleInToDB($articleTitle,$articleDetails,$imgRoute,$artFile,$IdNumber,$idUser);
}
